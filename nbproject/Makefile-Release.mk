...
${OBJECTDIR}/URI_CHEFE_1469.o: URI_CHEFE_1469.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/URI_CHEFE_1469.o URI_CHEFE_1469.cpp

${OBJECTDIR}/URI_REDUZINDO_DETALHES_EM_UM_MAPA_2404.o: URI_REDUZINDO_DETALHES_EM_UM_MAPA_2404.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/URI_REDUZINDO_DETALHES_EM_UM_MAPA_2404.o URI_REDUZINDO_DETALHES_EM_UM_MAPA_2404.cpp

${OBJECTDIR}/URI_TODOS_OS_DISCOS_CONSIDERADOS.o: URI_TODOS_OS_DISCOS_CONSIDERADOS.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/URI_TODOS_OS_DISCOS_CONSIDERADOS.o URI_TODOS_OS_DISCOS_CONSIDERADOS.cpp
